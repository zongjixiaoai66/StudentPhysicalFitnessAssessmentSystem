      ...
      <el-form :inline="true" :model="searchForm" class="form-content">
        ...
        <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
          <el-form-item>
            ...
            <el-button
              v-if="isAuth('xuesheng','导入') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 1"
              type="success"
              icon="el-icon-plus"
              @click="importHandler()"
            >{{ contents.btnAdAllFont == 1?'导入':'' }}</el-button>
            <el-button
              v-if="isAuth('xuesheng','导入') && contents.btnAdAllIcon == 1 && contents.btnAdAllIconPosition == 2"
              type="success"
              @click="importHandler()"
            >{{ contents.btnAdAllFont == 1?'导入':'' }}<i class="el-icon-plus el-icon--right" /></el-button>
            <el-button
              v-if="isAuth('xuesheng','导入') && contents.btnAdAllIcon == 0"
              type="success"
              @click="importHandler()"
            >{{ contents.btnAdAllFont == 1?'导入':'' }}</el-button>
