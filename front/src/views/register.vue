<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">小学生身体素质测评管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<el-form-item label="学校" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xuexiao" autocomplete="off" placeholder="学校"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
